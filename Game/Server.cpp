...
void Server::printpeerinfo(struct sockaddr* peer_sockaddr, uint* peer_addrlen){
	void *addr, *port;
	char* ipver;
...
int Server::initialiselistener(struct addrinfo hints, struct addrinfo* res, int* sockfd_listener){
...
int Server::receive_client(int client_sockfd, char* buffer){
...
void Server::accept_client(	int* client_sockfd,
					int* server_sockfd,
...
void Server::request_clientname(std::map<int, std::string> client_names, int sockfd_client){
